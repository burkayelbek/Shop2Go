...
namespace Shop2GoAPI.Migrations
{
    ...
    [Migration("20210306132720_Category_Created")]
    partial class Category_Created
    {
            ...
            modelBuilder.Entity("Shop2GoAPI.Models.Products", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 1000f,
                            PublishedDate = new DateTime(2021, 3, 6, 16, 27, 19, 838, DateTimeKind.Local).AddTicks(9908),
                            Title = "Test Title"
                        });
                });
